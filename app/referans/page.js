          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-muted max-w-2xl mx-auto">
                Eğitimden teknolojiye, inovasyondan araştırmaya birçok alanda
                öncü kurumlarla çalışıyoruz
              </p>
            </motion.div>
              ...
              {references.map((ref, i) => (
                ...
                >
                  ...
                  <div className="relative h-64 sm:h-72 overflow-hidden bg-gradient-to-br from-accent/5 to-transparent">
                    <Image
                      src={ref.image}
                      alt={`${ref.name} - ${ref.description} - Caplin3D Referans`}
                      fill
            ...
            >
              ...
              <div className="relative text-center">
                ...
                <p className="text-sm sm:text-base text-muted max-w-2xl mx-auto mb-8 leading-relaxed">
                  ...
                  hizmet sunuyoruz. Sizin projeniz de bir sonraki başarı
                  hikayemiz olabilir.
                </p>
